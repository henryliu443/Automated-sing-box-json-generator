...
# 与 acme 签发一致：/etc/sing-box/certs/（见 certs.py）
TUIC_CERT_PATH = "/etc/sing-box/certs/tuic.crt"
TUIC_KEY_PATH = "/etc/sing-box/certs/tuic.key"
HY2_CERT_PATH = "/etc/sing-box/certs/hy2.crt"
HY2_KEY_PATH = "/etc/sing-box/certs/hy2.key"


def build_certificates_provider():
    return [
        {"tag": "tuic-cert", "certificate_path": TUIC_CERT_PATH, "key_path": TUIC_KEY_PATH},
        {"tag": "hy2-cert", "certificate_path": HY2_CERT_PATH, "key_path": HY2_KEY_PATH},
    ]


def build_protocol_hosts(domain_root):
    """SNI 分段：jx1xfnke=reality, t7mmubf0=hy2, xts6e4iz=tuic"""
...
def build_client_outbounds(creds, hosts):
    return [
        ...
        },
        {
            ...
            "udp_relay_mode": "quic",
            "tls": {"enabled": True, "server_name": hosts["tuic"]},
        },
        {
            "type": "hysteria2",
            "tag": "hy2-out",
            ...
            "tls": {"enabled": True, "server_name": hosts["hy2"]},
        },
        {"type": "direct", "tag": "direct"},
    ]
...
def build_server_config(creds, protocol_hosts=None, warp_mode="proxy"):
    ...
    return {
        ...
        "certificates": build_certificates_provider(),
        "inbounds": [
            {
                "type": "anytls",
